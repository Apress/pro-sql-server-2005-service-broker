...
FROM 'd:\Klaus\Work\Private\Apress\Pro SQL 2005 Service Broker\Chapter 5\Samples\InventoryApplication\InventoryTargetService\bin\Debug\InventoryTargetService.dll'
GO

-- Add the debug information about the assembly
ALTER ASSEMBLY [InventoryTargetServiceAssembly]
ADD FILE FROM 'd:\Klaus\Work\Private\Apress\Pro SQL 2005 Service Broker\Chapter 5\Samples\InventoryApplication\InventoryTargetService\bin\Debug\InventoryTargetService.pdb'
GO

ALTER ASSEMBLY [ServiceBrokerInterface]
ADD FILE FROM 'd:\Klaus\Work\Private\Apress\Pro SQL 2005 Service Broker\Chapter 5\Samples\InventoryApplication\ServiceBrokerInterface\bin\Debug\ServiceBrokerInterface.pdb'
GO
