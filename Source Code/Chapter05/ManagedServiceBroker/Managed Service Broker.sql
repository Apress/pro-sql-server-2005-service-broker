...
FROM 'd:\Klaus\Work\Private\Apress\Pro SQL 2005 Service Broker\Chapter 5\Samples\ManagedServiceBroker\BackendService\bin\Debug\BackendService.dll'
GO

-- Add the debug information about the assembly
ALTER ASSEMBLY [BackendServiceAssembly]
ADD FILE FROM 'd:\Klaus\Work\Private\Apress\Pro SQL 2005 Service Broker\Chapter 5\Samples\ManagedServiceBroker\BackendService\bin\Debug\BackendService.pdb'
GO
...
FROM 'd:\Klaus\Work\Private\Apress\Pro SQL 2005 Service Broker\Chapter 5\Samples\ManagedServiceBroker\InitiatorService\bin\Debug\InitiatorService.dll'
GO

-- Add the debug information about the assembly
ALTER ASSEMBLY [InitiatorServiceAssembly]
ADD FILE FROM 'd:\Klaus\Work\Private\Apress\Pro SQL 2005 Service Broker\Chapter 5\Samples\ManagedServiceBroker\InitiatorService\bin\Debug\InitiatorService.pdb'
GO
