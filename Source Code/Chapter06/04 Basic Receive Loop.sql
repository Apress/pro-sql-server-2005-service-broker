...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'Chapter6_BasicReceiveLoop')
BEGIN
	PRINT 'Dropping database ''Chapter6_BasicReceiveLoop''';
	DROP DATABASE Chapter6_BasicReceiveLoop;
END
GO

CREATE DATABASE Chapter6_BasicReceiveLoop
GO

USE Chapter6_BasicReceiveLoop
GO
